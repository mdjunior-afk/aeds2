...
class Node {
  ...
  public Node(Game game, Node nextNode) {
    this.game = game;
...
public class Queue {
  ...
  public void enqueue(Game game) {
    Node newNode = new Node(game, null);
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (data[0].equals("I")) {
        ...
        System.out.println("(R) " + myGameList.dequeue().name);
      }
    }
